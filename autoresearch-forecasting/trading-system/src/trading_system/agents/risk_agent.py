...
def evaluate(
    ...
    # Build a minimal stand-in for stop_logic — it only uses a few fields.
    class _OFShim:
        spot = spot
        highest_call_oi_strike = int(of_dict.get("highest_call_oi_strike", 0))
        highest_put_oi_strike = int(of_dict.get("highest_put_oi_strike", 0))
        expected_range_high = int(of_dict.get("highest_call_oi_strike", 0))
        expected_range_low = int(of_dict.get("highest_put_oi_strike", 0))
        atm_strike = int(of_dict.get("atm_strike", 0))
        atm_straddle_price = float(of_dict.get("atm_straddle_price", 0))
